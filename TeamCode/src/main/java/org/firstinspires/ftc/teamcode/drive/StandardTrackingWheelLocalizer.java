...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 9.482; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -6.11; // in; offset of the lateral wheel
    ...
    public static double X_MULTIPLIER = 1.01924;
    public static double Y_MULTIPLIER = 1.01651;
